#' @title The `language` dataset
#'
#' @description `language` data provides the word "hello" in different languages.
#'
#' @format  This is a `data.frame` with `r nrow(language)` rows and `r ncol(language)` columns:
#'
